package sh.estienne.lab3app;

import sh.estienne.lab3app.util.JsfUtil;
import sh.estienne.lab3app.util.PaginationHelper;
...
public class ContactController implements Serializable {
    ...
    @EJB
    private sh.estienne.lab3app.ContactFacade ejbFacade;

package sh.estienne.appuser;

import sh.estienne.appuser.util.JsfUtil;
import sh.estienne.appuser.util.PaginationHelper;
...
public class AppUserController implements Serializable {
    ...
    @EJB
    private sh.estienne.appuser.AppUserFacade ejbFacade;
